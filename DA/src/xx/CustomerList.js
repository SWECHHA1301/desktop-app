    ...
    <div className="customer-panel">
      ...
      {customers.map((cust, index) => (
        <div key={index} className="drawer-card">
          <div className="drawer-header" onClick={() => toggleDrawer(index)}>
            ...
            <div className="drawer-content">
              <div className="drawer-info-top">
                ...
                <div className="drawer-info-right">
                  <div>Due Balance: <strong className="drawer-due">₹ {cust.dueBalance}</strong></div>
              ...
              <div className="drawer-buttons">
                <button><Clock size={14} /> History</button>
                <button><PlusCircle size={14} /> Add Order</button>
                <button><Bell size={14} /> Remind</button>
                <button><Pencil size={14} /> Edit Info</button>
              </div>
            </div>
          )}
        </div>
